...
<html lang="en">
	<head>
		...
		<meta charset="utf-8">
		<title>Orbitando - Estudio creativo</title>
...
<header class="masthead">
    ...
    <div id="myCarousel" class="carousel slide">
      ...
      <div class="logo container-fluid">Orbitando.cl</div> 
      <!-- Controls -->
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse">
        <ul class="nav navbar-nav nav-justified">
         ...
         <li class="dropdown">
            <a  class="dropdown-toggle" data-toggle="dropdown">Galerías <b class="caret"></b></a>
            <ul class="dropdown-menu">
              <li><a href="#section3">Fotograías</a></li>
              <li><a href="#section3">Videos</a></li>
            </ul>
          </li>
          <li><a href="#section2">Acerca de</a></li>
          <li><a href="#section5">Contactar</a></li>
        </ul>
      </div><!--/.nav-collapse -->
    </div><!--/.container -->
</div><!--/.navbar -->
...
<div class="container">
  <div class="col-sm-10 col-sm-offset-1">
    <div class="page-header text-center">
      <h1>Orbitando.cl - todo el </h1>
    </div>
    
    <p class="lead text-center"> 
      Orbitando.cl cubre todos los espacios que qieras con fotografías y videos.
    </p> 
